...
ActiveRecord::Schema[7.0].define(version: 2023_08_10_110921) do
  ...
  create_table "pets", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "happiness", default: 0, null: false
    t.integer "hunger", default: 100, null: false
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "fk_rails_0fa4bae6b1"
  end
  ...
  create_table "toys", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pet_id"], name: "fk_rails_b8393480fd"
  end
